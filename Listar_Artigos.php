...
<section class="col-12 container " style="">
        ...
        <div class="row">
            <h1 class="col-12 text-white fundo-azul mb-5 ">Categoria: Perdidos recentemente</h1>
...
WHERE (((ocorrencia.classificacao)='perdido') AND ((ocorrencia.entregue)='nao') AND 
((ocorrencia.publicado)='nao'))
