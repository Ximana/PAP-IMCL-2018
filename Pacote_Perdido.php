...
<section class="col-12 container " style="">
        ...
        <div class="row">
            <h1 class="col-12 text-white fundo-azul mb-5 ">Categoria: Pacote Fechado Achado</h1>
...
$query = "SELECT artigo.descricao, artigo.imagem, ocorrencia.data "
        ...
        . "WHERE (((categoria.descricao)='Pacote Fechado') AND "
        . "((ocorrencia.classificacao)='perdido') AND ((ocorrencia.entregue)='nao') "
